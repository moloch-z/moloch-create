module.exports = {
  // 规则中文网址 https://cloud.tencent.com/developer/chapter/12618
  ...
  "no-global-assign": 2, // 禁止修改全局对象
  "no-unexpected-multiline": 2, //避免多行表达式
  "no-underscore-dangle": 0, //标识符不能以_开头或结尾
  "no-unneeded-ternary": 2, //禁止不必要的嵌套 var isYes = answer === 1 ? true : false;
  "no-unreachable": 2, //不能有无法执行的代码
  "no-unused-expressions": [2, { "allowShortCircuit": true, "allowTernary": true }], //提示无用的表达式
